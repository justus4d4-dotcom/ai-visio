// AI Image Interpreter ESP32 display firmware (Arduino IDE version).
//
// Hardware: Waveshare ESP32-S3-Touch-LCD-1.28 (GC9A01 round LCD + CST816S touch).
//
// This is the Arduino IDE port of firmware/src/main.cpp. It is identical except
// that SCREEN_WIDTH/SCREEN_HEIGHT (provided by PlatformIO build flags in the
// PlatformIO build) are defined here directly.
//
// Behaviour:
...
//
// Required libraries (Library Manager): LovyanGFX, ArduinoJson, WiFiManager (tzapu).
// Board: "ESP32S3 Dev Module". See firmware/README.md for the exact board settings.
...
// OTA (over-the-air) update identity.
...
// Enable over-the-air updates (Arduino IDE network port / PlatformIO espota).
